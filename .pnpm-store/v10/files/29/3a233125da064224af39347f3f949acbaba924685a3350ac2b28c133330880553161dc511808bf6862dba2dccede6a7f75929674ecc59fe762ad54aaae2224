import { s as relative } from "./pathe.M-eThtNZ-C6qzirxH.mjs";
...
function getFileProtocolModuleFormat(url, _context, ignoreErrors) {
	...
	const format$1$1 = extensionFormatMap[ext];
	if (format$1$1) return format$1$1;
...
//#endregion
export { resolveModulePath as a, withNodePath as i, tryResolveNuxt as n, relativeToProcess as r, loadKit as t };