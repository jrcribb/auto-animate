import { t as consola } from "./dist-0DfurPla.mjs";
import { existsSync } from "node:fs";

//#region ../../node_modules/.pnpm/untun@0.1.3/node_modules/untun/dist/index.mjs
async function startTunnel(opts) {
	const { installCloudflared, startCloudflaredTunnel, cloudflaredBinPath, cloudflaredNotice } = await import("./chunks-BAPtqiwP.mjs");
