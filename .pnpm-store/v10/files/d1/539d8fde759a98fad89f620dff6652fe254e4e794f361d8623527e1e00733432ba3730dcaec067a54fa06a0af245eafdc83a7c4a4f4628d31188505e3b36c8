...
import { c as Pt, d as Wt, g as zt, n as logger, p as kt } from "./logger-O9Su9xI5.mjs";
import { t as defu } from "./defu-B9sWDZZ9.mjs";
import { r as relativeToProcess, t as loadKit } from "./kit-mAWtuYKF.mjs";
import { a as join, c as resolve } from "./pathe.M-eThtNZ-C6qzirxH.mjs";
import { i as FastURL, r as NodeResponse, t as serve } from "./node-Bh-2wEyO.mjs";
import { n as clearDir } from "./fs-DfmpLQNk.mjs";
...
var analyze_default = defineCommand({
	...
	async run(ctx) {
		...
		Pt(colors.cyan("Analyzing bundle size..."));
		const startTime = Date.now();
		const { loadNuxt, buildNuxt } = await loadKit(cwd$1);
