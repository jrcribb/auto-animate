...
var Consola = class Consola {
	...
	*/
	constructor(options = {}) {
		const types$1 = options.types || LogTypes;
		this.options = defu({
			...options,
			defaults: { ...options.defaults },
			level: _normalizeLogLevel(options.level, types$1),
...
function _normalizeLogLevel(input, types$1 = {}, defaultLevel = 3) {
	if (input === void 0) return defaultLevel;
	if (typeof input === "number") return input;
	if (types$1[input] && types$1[input].level !== void 0) return types$1[input].level;
	return defaultLevel;
}
...
function createConsola$1(options = {}) {
	...
	return createConsola({
		...
		prompt: (...args) => import("./prompt-C19ipYSP.mjs").then((m) => m.prompt(...args)),
...
//#endregion
export { colors as n, getColor$1 as r, consola as t };